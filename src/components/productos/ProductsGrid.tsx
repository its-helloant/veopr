    ...
    <>
      ...
      {products.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-700 mb-4 sm:mb-6">No se encontraron productos</h3>
          <p className="text-sm sm:text-base text-gray-500">Intenta ajustar tus filtros o términos de búsqueda</p>
        </div>
      )}
    </>
  );
